...
const PaymentSuccess = () => {
  ...
  if (error)
    return (
      <p className="text-center text-red-500">Error fetching booking details</p>
    );
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-900">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg max-w-5xl w-full flex flex-col md:flex-row gap-8 text-white">
        ...
        <div className="md:w-2/3 text-center md:text-left">
          ...
          <p className="text-gray-300 mt-2">Your booking has been confirmed.</p>
          <h3 className="text-2xl font-bold mt-4">{movie?.title}</h3>
          <p className="text-gray-300 mt-2">
            <span className="font-semibold text-gray-200">Show Date:</span>{" "}
            {formattedDate}
          </p>
          <p className="text-gray-300">
            <span className="font-semibold text-gray-200">Show Time:</span>{" "}
            {formattedTime}
          </p>
          <p className="text-gray-300">
          ...
          <p className="text-gray-300 mt-2">
            <span className="font-semibold text-gray-200">Transaction ID:</span>{" "}
            <span className="font-mono text-blue-400">{transactionId}</span>
          </p>
          <button
            className="mt-6 px-5 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 w-full md:w-auto shadow-md"
